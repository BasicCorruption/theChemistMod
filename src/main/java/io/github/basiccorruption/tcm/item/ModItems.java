...
public class ModItems {
    ...
    public static final Item LITHIUM_INGOT = registerItem("lithium_ingot", new Item(new FabricItemSettings().group(ItemGroup.MISC)));
    public static final Item LITHIUM_NUGGET = registerItem("lithium_nugget", new Item(new FabricItemSettings().group(ItemGroup.MISC)));
    public static final Item LITHIUM_DUST = registerItem("lithium_dust", new Item(new FabricItemSettings().group(ItemGroup.MISC)));
